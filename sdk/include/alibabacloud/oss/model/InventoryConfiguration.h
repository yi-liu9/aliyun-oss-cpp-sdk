...
namespace OSS
{
    ...
    using OptionalFields = std::vector<std::string>;
    ...
    public:
        ...
        const std::string& IncludedObjectVersions() const { return includedObjectVersions_; }
        ...
        void setSchedule(const std::string& schedule) { schedule_ = schedule; }
        void setIncludedObjectVersions(const std::string& includedObjectVersions) { includedObjectVersions_ = includedObjectVersions; }
    ...
    private:
        ...
        std::string includedObjectVersions_;
